...
window.addEventListener("load", function () {
  ...
  let currentFilter = sortList.querySelector(".item:first-child");
  ...
  async function getTotalRecord(arrow) {
    ...
    let response = await fetch(`/api/smalltalks/total-data?q=${query}`);
      ...
      let template = `
                                    <li class="item">
                                      <div class="board">
                                          ...
                                          <div class="title-box">
                                              <a class="title" href="/smalltalk/detail?id=${l.id}">${l.title}</a>
                                          </div>
  ...
  async function getBoardList() {
    ...
    let response = await fetch(`/api/smalltalks?p=${page}&q=${query}&f=${filterId}`);
