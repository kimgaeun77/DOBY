...
illegal:"\\S"}}})();hljs.registerLanguage("json",e)})();/*! `qml` grammar compiled for Highlight.js 11.8.0 */
...
;hljs.registerLanguage("qml",e)})();/*! `sql` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict";return e=>{
