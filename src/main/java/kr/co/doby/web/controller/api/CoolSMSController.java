...
public class CoolSMSController {
    ...
    public CoolSMSController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCSF8XMD9NKOWRN7", "6QROX9HAN2XDQJAKEIGZU8OG8XEWQT5Y", "https://api.coolsms.co.kr");
    }
    ...
    public MessageListResponse getMessageList(
            @RequestParam(name = "p", required = false) String phoneNum
    ) {
    ...
    public SingleMessageSentResponse sendOne(@RequestBody Message message1) {
        Message message = new Message();
        // 발신번호 및 수신번호는 반드시 01012345678 형태로 입력되어야 합니다.
        message.setFrom("01047430865");
        message.setTo(message1.getTo());
